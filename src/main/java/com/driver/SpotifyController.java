...
public class SpotifyController {
    ...
    public String createPlaylistOnName(@RequestBody String mobile, @RequestBody String title, @RequestBody List<String> songTitles) throws Exception{
    ...
    public String likeSong(@RequestParam String mobile,@RequestParam String songTitle) throws Exception{
        ...
        }catch (UserNotFoundException | SongNotFoundException exception){
